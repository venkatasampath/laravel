...
Route::group([
    ...
    // Missing Persons
    Route::resource('missingpersons', 'MissingPersonsController');
//    Route::get('/missingpersons', 'MissingPersonsController@index');
//    Route::get('/missingpersons/{id}', 'MissingPersonsController@show');
//    Route::get('/missingpersons/{id}/edit', 'MissingPersonsController@edit');
//    Route::get('/missingpersons/create', 'MissingPersonsController@create');
...
Route::group([
    ...
    Route::get('dental', ['as' => 'dental', 'uses' => 'ReportsController@dental']);
