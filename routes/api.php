...
Route::group([
    ...
    Route::get('/projects/{project}/dental', 'Api\ReportsController@getProjectDental');
...
Route::group([
    'prefix' =>'missingpersons',
    'middleware' => 'auth:api'
], function () {
    Route::get('/', 'Api\MissingPersonsController@index');
    Route::get('/{missing_person}', 'Api\MissingPersonsController@show');
    Route::put('/{missing_person}', 'Api\MissingPersonsController@update');
    Route::post('/', 'Api\MissingPersonsController@store');
});
...
Route::group([
    ...
    Route::put('/{gn}', 'Api\GenealogyController@update');
    Route::post('/', 'Api\GenealogyController@store');
});
