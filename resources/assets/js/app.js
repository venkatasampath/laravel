...
//Missing Persons
Vue.component('missingpersonlist', require('./components/missingpersons/MissingPersonsList').default);
Vue.component('missingperson', require('./components/missingpersons/MissingPersons').default);
Vue.component('missingpersoncreate', require('./components/missingpersons/MissingPersonsCreate').default);
Vue.component('MissingpersonCrud', require('./components/missingpersons/MissingPersonsCrud').default);
