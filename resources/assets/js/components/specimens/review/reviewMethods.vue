                ...
                <v-expansion-panels v-for="(item, index) in Features" :key="index">
                    <v-expansion-panel>
                        <v-expansion-panel-header>
                            <v-row class="align-center justify-center" dusk="biologicalProfile-dropdown"><span>{{ displayName(item[0].method_id, 'type') }} - {{displayName(item[0].method_id, 'name')}}</span>
                            </v-row>
                        </v-expansion-panel-header>
