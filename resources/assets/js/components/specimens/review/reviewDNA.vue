        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <v-expansion-panels v-for="(dna, index) in constructDisplayDNAItems" :key="index">
                    <v-expansion-panel>
                        <v-expansion-panel-header dusk="DNA-dropdown">{{ index }}</v-expansion-panel-header>
                        <v-expansion-panel-content>
                            <!--  Second layer -->
                            <v-expansion-panels>
                                <v-expansion-panel>
                                    <v-expansion-panel-header dusk="DNA-general">General</v-expansion-panel-header>
                                    <v-expansion-panel-content>
                                        <v-row>
                                            <v-col cols="6">
                                            ...
                                            <v-col cols="6">
                                                <v-text-field v-for="(item, key) in dna.base"
                                                              ...
                                                              @change="v => state.review[index][key] = v" :dusk="`DNA-general-`+ key">
                                                </v-text-field>
                                                <v-autocomplete v-for="(item, key) in dna.base"
                                                                :key="key"
                                                                v-if="key.indexOf('lab_id') !== -1"
                            ...
                            <v-expansion-panels>
                                <v-expansion-panel>
                                    <v-expansion-panel-header dusk="DNA-auSTR">auSTR</v-expansion-panel-header>
                                    <v-expansion-panel-content>
                                        <v-row>
                                            <v-col cols="6">
                                            ...
                                            <v-col cols="6">
                                                <v-autocomplete v-for="(item, key) in dna.austr"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.austrmethodoptions"
                                                                :dusk="`austr-`+ key">
                                                </v-autocomplete>
                                                <v-autocomplete v-for="(item, key) in dna.austr"
                                                                :key="key"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.austrstatusoptions"
                                                                :dusk="`austr-`+ key">
                                                </v-autocomplete>
                                                <v-text-field v-for="(item, key) in dna.austr"
                                                              :key="key"
                                                              v-if="key.lastIndexOf('date') === -1 && key.indexOf('austr_results_confidence') && key.indexOf('austr_method')"
                                                              :label="generateLabel(key)"
                                                              v-model="state.review[index][key]" :dusk="`austr-`+ key">
                                                </v-text-field>
                                                <v-menu v-for="(item, key) in dna.austr"
                                                        :key="key"
                                                        v-if="key.lastIndexOf('date') !== -1"
                            ...
                            <v-expansion-panels>
                                <v-expansion-panel>
                                    <v-expansion-panel-header dusk="DNA-Mito">Mito</v-expansion-panel-header>
                                    <v-expansion-panel-content>
                                        <v-row>
                                            <v-col cols="6">
                                            ...
                                            <v-col cols="6">
                                                <v-autocomplete v-for="(item, key) in dna.mito"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.mitomethodoptions"
                                                                :dusk="`Mito-`+key">
                                                </v-autocomplete>
                                                <v-text-field v-for="(item, key) in dna.mito"
                                                              :key="key"
                                                ...
                                                <v-autocomplete v-for="(item, key) in dna.mito"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.list_confidence"
                                                                :dusk="`Mito-`+key">
                                                </v-autocomplete>
                                                <v-autocomplete v-for="(item, key) in dna.mito"
                                                                :key="key"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.mitohaplooptions"
                                                                :dusk="`Mito-`+key">
                                                </v-autocomplete>
                                                <v-menu v-for="(item, key) in dna.mito"
                                                        :key="key"
                            ...
                            <v-expansion-panels>
                                <v-expansion-panel>
                                    <v-expansion-panel-header dusk="DNA-ySTR">ySTR</v-expansion-panel-header>
                                    <v-expansion-panel-content>
                                        <v-row>
                                            <v-col cols="6">
                                            ...
                                            <v-col cols="6">
                                                <v-autocomplete v-for="(item, key) in dna.ystr"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.ystrmethodoptions"
                                                                :dusk="`ystr-`+key">
                                                </v-autocomplete>
                                                <v-text-field v-for="(item, key) in dna.ystr"
                                                              :key="key"
                                                ...
                                                <v-autocomplete v-for="(item, key) in dna.ystr"
                                                                ...
                                                                :label="generateLabel(key)"
                                                                v-model="state.review[index][key]"
                                                                :items="list_options.ystrhaplooptions"
                                                                :dusk="`ystr-`+key">
                                                </v-autocomplete>
                                                <v-menu v-for="(item, key) in dna.ystr"
                                                        :key="key"
