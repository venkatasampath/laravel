<template>
    <v-autocomplete id="completeness" name="completeness" v-model="completeness" :key="completeness" :dusk="dusk" :label="label" placeholder="Select Completeness"
...
<script>
    export default {
        ...
        props: {
            ...
            dusk :{ type: String, default: "se-completeness" },
