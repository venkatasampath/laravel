<template>
    <div class="m-2">
      ...
      <v-alert class="my-1" border="left" colored-border type="info" elevation="2" dismissible>{{alertText}}</v-alert>
                    ...
                    <v-stepper-content step="1">
                        <v-card>
                            <v-row class="px-2">
                                ...
                                <v-col cols="3"><completeness @input="(val) => {form.completeness = val}"/></v-col>
                            </v-row>
                            <v-row  class="px-2">
                                <v-col>
                    ...
                    <v-stepper-content step="2">
                        <v-card flat>
                            <v-row  class="px-2">
                                ...
                                <v-col cols="12" md="3" v-if="!theProject.uses_auto_increment_designator"><dn @input="(val) => {form.designator = val}"/></v-col>
                            </v-row>
                        </v-card>
                        <v-card-actions>
                            <v-row class="justify-center">
        ...
        data() {
            return {
                ...
                form: { org_id: null, project_id: null, bone_group: "", bones: [], side: 'Left', completeness: 'Complete',
                    accession_number: null, provenance1: null, provenance2: null, starting_designator: 0,
                ...
                bone_group_list:[],
                alert: false,
                alertText: "This project uses auto-increment designator field",
            }
        },
        created() {
