  ...
  data() {
    return {
      ...
      items: [
        ...
        { text: 'Missing Persons', icon: 'mdi-badge-account-horizontal', 'icon-alt': 'mdi-badge-account-horizontal-outline', model: false, permission: 'browse_skeletal_elements',
          children: [
            { text: 'Browse Listing', icon: 'mdi-badge-account', href: '/missingpersons', permission: 'browse_skeletal_elements' },
          ],
        },
