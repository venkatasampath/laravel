    ...
    <v-card flat>
        <v-container fluid class="m-0 p-0">
            <v-toolbar>
                ...
                <v-btn :title="!isCollapseAll ? 'Collapse All' : 'Expand All'" icon v-if="show_collapse_all_menu" color="primary" dusk="collapse-all" @click="fireEventCollapseAll()">
                ...
                <!-- Specimen Action Menu - Start-->
                <v-btn dusk="dashboard-settings" title="Dashboard Settings" v-if="show_dashboard_menu" color="primary" icon>
